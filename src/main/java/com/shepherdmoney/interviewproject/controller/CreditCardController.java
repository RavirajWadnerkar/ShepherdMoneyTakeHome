...
public class CreditCardController {
	...
	public ResponseEntity<Object> addCreditCardToUser(@RequestBody AddCreditCardToUserPayload payload) {
		...
		CreditCardView creditCardView = creditCardService.createCreditCard(payload);
		return GeneralResponseEntity.generateResponse("created credit-card!!", HttpStatus.OK, creditCardView);

	}

	@GetMapping("/credit-card:all")
	public ResponseEntity<Object> getAllCardOfUser(@RequestParam int userId) {
		// TODO: return a list of all credit card associated with the given userId,
		// using CreditCardView class
		// if the user has no credit card, return empty list, never return null
		List<CreditCardView> creditCardView = creditCardService.getAllCreditCardsByUserId(userId);
		return GeneralResponseEntity.generateResponse("created credit-card!!", HttpStatus.OK, creditCardView);
	}

	@GetMapping("/credit-card:user-id")
	public ResponseEntity<Object> getUserIdForCreditCard(@RequestParam String creditCardNumber) {
		...
		int userId = creditCardService.getUserIdByCradNo(creditCardNumber);
		return GeneralResponseEntity.generateResponse("created credit-card!!", HttpStatus.OK, userId);
	}
